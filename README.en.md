...
- Local Web version, Capacitor Android shell, and Flutter Android 0.2.4 mobile package.
...
This package is built with Flutter, Dart, Material 3, and the native Android build chain. Its package name is `studio.inventory.mobile`, version `0.2.4`. The distributable APK is an arm64 release build; debug APKs are only for local testing. SHA-256: `b57e4b41e766bb23b5f782340348c30d0f2ce70898da6caca129c4b113d8a776`.
